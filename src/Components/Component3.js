...
const Component3 = (props) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'row', gap: '1rem', width: "100%", justifyContent: "center", alignItems: "center", marginBottom: "1rem", border: '2px solid black', padding: '1%'}}>
